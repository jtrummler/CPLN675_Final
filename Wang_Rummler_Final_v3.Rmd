...
ggplot()+
  ...
  geom_sf(data=nashville, fill='red', color='red')+
...
First, we look at the land cover in the year 2009.
...
ggplot() +
  ...
  labs(title = "Land Cover (2009)", subtitle="Nashville MSA") +
...
ggplot() +
  ...
  labs(title = "Land Cover Change (2009 to 2019)", subtitle="Nashville MSA") +
  mapTheme() +
  theme(legend.position="bottom")
```
...
ggplot()+
  ...
  scale_fill_viridis(option="G", direction=-1,
                     name="Count") +
  labs(title="Fishnet: Count of Building Permits", subtitle="Nashville MSA (2020 to 2023)")+
  mapTheme()
